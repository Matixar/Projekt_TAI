...
return [
    ...
    */
    ...
    'attributes' => [
        'Please confirm your password before continuing.' => 'Proszę potwierdzić swoje hasło przed kontynuacją',
        'Confirm Password' => 'Potwierdź hasło',
        'password' => 'Hasło',
        'Forgot Your Password?' => 'Zapomniałeś hasła?',
        'Reset Password' => 'Zresetuj hasło',
        'E-Mail Address' => 'Adres email',
        'Send Password Reset Link' => 'Wyślj link do zresetowania hasła',
        'Confirm Password' => 'Potwierdź hasło',
        'login' => 'Logowanie',
